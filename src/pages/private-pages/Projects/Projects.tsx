...
import { ProjectFilterList } from "../../../constants/Project";
...
const Projects = () => {
  ...
  return (
    ...
    //           />
    //         </Button>
    //         <Button onClick={handleClickOpen}>Create new Projects</Button>
    //       </div>
    //     </Grid>
    ...
    //                   <span>Manager: </span> {project.manager}
    //                 </li>
    //                 <li className="projectCard__info-item">
    //                   <span>client: </span> {project.client}
    //                 </li>
    //                 <li className="projectCard__info-item">
    //                   <span>LOI: </span> {project.LOI}
    //                 </li>
    //                 <li className="projectCard__info-item">
    //                   <span>Invite | Response: </span> {project.Invite}
    //                 </li>
    //                 <li className="projectCard__info-item">
    //                   <span>Completed: </span> {project.Completed}
    //                 </li>
    //                 <li className="projectCard__info-item">
    //                   <span>Incidence: </span> {project.Incidence}
    //                 </li>
    //               </ul>
